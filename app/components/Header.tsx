...
const Header = () => {
    ...
    const navItems = [
        ...
        { name: '매일묵상', eng: 'Daily Word', href: '/meditation' },
        { name: '주성소식', eng: 'Community', href: '/community' },
    ];
                ...
                <div className="fixed inset-0 z-[100] lg:hidden">
                    ...
                    <div className="absolute right-0 top-0 h-full w-full max-w-[360px] bg-white shadow-2xl p-12 flex flex-col transform transition-transform duration-500 animate-in slide-in-from-right">
                        ...
                        <div className="mt-auto pt-10 border-t border-stone-100">
                            <p className="text-[10px] font-black uppercase text-stone-300 tracking-[0.5em] mb-4 text-center">Connected Together</p>
