...
export default function TiltCard({ children, className = "", onClick }: TiltCardProps) {
    ...
    // Mouse position mapped to rotation degrees
    const rotateX = useTransform(y, [-0.5, 0.5], [15, -15]); // Up/Down tilt
    const rotateY = useTransform(x, [-0.5, 0.5], [-15, 15]); // Left/Right tilt
