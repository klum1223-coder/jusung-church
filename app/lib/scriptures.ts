export interface Scripture {
    text: string;
    source: string;
    category: 'comfort' | 'wisdom' | 'hope' | 'love' | 'strength';
}
...
export const SCRIPTURES: Scripture[] = [
    ...
    {
        text: "내가 평안히 눕고 자기도 하리니 나를 안전히 살게 하시는 이는 오직 여호와이시니이다",
        source: "시편 4:8",
        category: "comfort"
    },
    {
    ...
    {
        text: "너는 내일 일을 자랑하지 말라 하루 동안에 무슨 일이 일어날는지 네가 알 수 없음이니라",
        source: "잠언 27:1",
        category: "wisdom"
    },
    {
    ...
    {
        text: "너희가 전에는 어둠이더니 이제는 주 안에서 빛이라 빛의 자녀들처럼 행하라",
        source: "에베소서 5:8",
        category: "hope"
    }
];
